...
%sthn synexeia
if X(V(1,1),V(2,1),1) == 0.8 && X(V(1,1),V(2,1),2)== 0.8 && X(V(1,1),V(2,1),3) == 0.8
X(V(1,1),V(2,1),1) = CV(1,1);
X(V(1,1),V(2,1),2) = CV(1,2);
X(V(1,1),V(2,1),3) = CV(1,3);
end
if X(V(1,2),V(2,2),1) == 0.8 && X(V(1,2),V(2,2),2)== 0.8 && X(V(1,2),V(2,2),3) == 0.8
X(V(1,2),V(2,2),1) = CV(2,1);
X(V(1,2),V(2,2),2) = CV(2,2);
X(V(1,2),V(2,2),3) = CV(2,3);
end
if X(V(1,3),V(2,3),1) == 0.8 && X(V(1,3),V(2,3),2)== 0.8 && X(V(1,3),V(2,3),3) == 0.8
                 ...
                 if warn<=1
                    ...
                    if LAOP(p,3) == 1%elegxw se poia pleura vriskomai wste na parw ta katallhla shmeia gia na vrw thn apostash apo to trexon oriako shmeio.
                     ...
                     %upoloipes einai aparaithtos elegxos.      
                        if X(x,y,1) == 0.8 && X(x,y,2)== 0.8 && X(x,y,3) == 0.8
    ...
    %Pali skanarw ola ta dunata x.
     for x = xmin:1:xmax
         ...
         for p = 1:1:to(1)
           ...
           if X(x,y,1) == 0.8 && X(x,y,2)== 0.8 && X(x,y,3) == 0.8%elegxw an einai vammeno h oxi gia ton idio logo pou exei hdh anaferthei.
